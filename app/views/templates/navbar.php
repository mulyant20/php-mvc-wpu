<nav class="bg-neutral-800">
  ...
  <div class="mobile-menu hidden md:hidden py-4 px-4 flex-col gap-4">
    <a href="<?= BASEURL ?>/about/index" class="block py-2 px-4 text-sm hover:bg-gray-200 text-white hover:text-gray-800">About</a>
    <a href="<?= BASEURL ?>/talents/index" class="block py-2 px-4 text-sm hover:bg-gray-200 text-white hover:text-gray-800">Talents</a>
